...
const SheTalksBanner = dynamic(() => import('@/components/work-detail/sheTalksBanner'), {
  loading: () => <div className="h-[60vh] animate-pulse bg-gray-200" />
});

const SheTalksCasestudy = dynamic(() => import('@/components/work-detail/sheTalksCasestudy'), {
  loading: () => <div className="h-[400px] animate-pulse bg-gray-200" />
});

const SheTalksGallery = dynamic(() => import('@/components/work-detail/sheTalksGallery'), {
  loading: () => <div className="h-[400px] animate-pulse bg-gray-200" />
});
