...
export default function MrCarsCasestudy() {
  const services = [
    ["App Development", "UI/UX Design", "Branding"],
    ["Car Service Integration", "Booking System"],
  ];
    ...
    <div className={`h-auto lg:h-screen bg-white px-5 md:px-16 lg:px-24 py-12 lg:py-28 lg:pb-0 ${poppins.className}`}>
      <div className="mx-auto space-y-8 md:space-y-16 lg:space-y-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
          ...
          <div className="lg:col-span-8">
            <p className="text-gray-600 leading-relaxed text-base md:text-lg">
              Mr Cars is a mobile app that simplifies vehicle care by connecting users with trusted car service providers. The app allows users to book, track, and manage car maintenance and repair services easily across Saudi Arabia.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
          ...
          <div className="lg:col-span-8">
            <p className="text-gray-600 leading-relaxed text-base md:text-lg">
              The challenge was to create a user-friendly platform that streamlines the process of finding and booking car services, while ensuring quality and reliability for users.
            </p>
          </div>
        </div>
