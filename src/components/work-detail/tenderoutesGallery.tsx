      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="relative h-[300px]">
            <Image
              src="/images/Digital-Marketing/tenderoutes-min.jpg"
              alt="Tenderoutes Destination Photography"
              fill
          ...
          <div className="relative h-[300px]">
            <Image
              src="/images/Digital-Marketing/tenderoutes-min.jpg"
              alt="Tenderoutes Social Media Campaign"
              fill
              className="object-cover rounded-lg"
            />
          </div>
          <div className="relative h-[300px]">
            <Image
              src="/images/Digital-Marketing/tenderoutes-min.jpg"
              alt="Tenderoutes Travel Blogger Collaboration"
              fill
              className="object-cover rounded-lg"
            />
          </div>
