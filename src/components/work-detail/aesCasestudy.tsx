...
export default function AESCasestudy() {
    const services = [
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                Developed a visionary brand identity for AES School of Commerce, a premier accounting institute. Created a modern visual language that symbolizes progress, energy, and connectivity while maintaining academic excellence. The project encompassed comprehensive brand development, including guidelines and marketing materials.
              </p>
            </div>
          </div>
