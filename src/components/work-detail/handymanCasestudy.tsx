...
export default function HandymanCasestudy() {
  const services = [
    ["App Development", "UI/UX Design", "Branding"],
    ["Service Booking", "Real-time Tracking"],
  ];
    ...
    <div className={`h-auto lg:h-screen bg-white px-5 md:px-16 lg:px-24 py-12 lg:py-28 lg:pb-0 ${poppins.className}`}>
      <div className="mx-auto space-y-8 md:space-y-16 lg:space-y-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
          ...
          <div className="lg:col-span-8">
            <p className="text-gray-600 leading-relaxed text-base md:text-lg">
              Handyman is a mobile app that connects users with certified professionals for electrical and plumbing services. The app offers fast, safe, and reliable support, making it easy to book and manage service requests across Saudi Arabia.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
          ...
          <div className="lg:col-span-8">
            <p className="text-gray-600 leading-relaxed text-base md:text-lg">
              The challenge was to ensure a seamless user experience for booking urgent home services, while maintaining high standards of safety and professionalism among service providers.
            </p>
          </div>
        </div>
