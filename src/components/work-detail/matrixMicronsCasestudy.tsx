...
export default function MatrixMicronsCasestudy() {
    const services = [
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                Developed a professional brand identity for Matrix Microns, a global supplier of high-quality quartz lumps. Created a cohesive visual language that reflects their commitment to quality, sustainability, and global industrial applications while maintaining a modern and trustworthy image.
              </p>
            </div>
          </div>
