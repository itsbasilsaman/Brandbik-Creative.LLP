...
export default function CyberseedBrandingCasestudy() {
    const services = [
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                Developed a bold and modern brand identity for Cyberseed, a business consultancy firm. Created a cohesive visual language that reflects their innovative approach to digital solutions while maintaining a professional and trustworthy image. The project encompassed comprehensive brand development from logo design to marketing materials.
              </p>
            </div>
          </div>
