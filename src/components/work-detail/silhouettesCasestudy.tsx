...
export default function SilhouettesCasestudy() {
    const services = [
      ...
      <div className={`h-auto lg:h-screen bg-white px-5 md:px-16 lg:px-24 py-12 lg:py-28 lg:pb-0 ${poppins.className}`}>
        <div className="mx-auto space-y-8 md:space-y-16 lg:space-y-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                The challenge was to create a brand identity that would stand out in the competitive fashion market while maintaining an air of sophistication. The design needed to appeal to a discerning clientele while being versatile enough to work across various marketing channels.
              </p>
            </div>
          </div>
