export default function AboGlumboBanner() {
  return (
    <div 
      className="h-[600px] relative flex items-center px-5 md:px-16 lg:px-24"
      style={{
        backgroundImage: 'url(/images/app-development/abo-glumbo-banner.jpg)',
    ...
    >
      ...
      <div className="max-w-xl w-full space-y-6 relative z-10 text-white">
        <h1 className="text-white text-3xl md:text-4xl lg:text-4xl font-light leading-tight">
          Abo Glumbo: Connect with trusted professionals for home repairs, installations, and maintenance—all in one easy-to-use app.
        </h1>
