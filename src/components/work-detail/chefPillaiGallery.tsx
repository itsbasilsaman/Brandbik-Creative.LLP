...
export default function ChefPillaiGallery() {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="relative h-[300px]">
          <Image
            ...
            alt="Chef Pillai Food Photography"
            fill
        ...
        <div className="relative h-[300px]">
          <Image
            src="/images/Digital-Marketing/chef-pillai.jpg"
            alt="Chef Pillai Social Media Campaign"
            fill
            className="object-cover rounded-lg"
          />
        </div>
        <div className="relative h-[300px]">
          <Image
            src="/images/Digital-Marketing/chef-pillai.jpg"
            alt="Chef Pillai Influencer Collaboration"
            fill
            className="object-cover rounded-lg"
          />
        </div>
